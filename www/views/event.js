...
Event = (function() {
  ...
  Event.prototype.initialize = function(eventNode, options) {
    var attendCheckbox, attendStatusChanged, childField, childFieldRound, children, configKey, duration_splitted, end_hour, end_minute, end_time, event, eventField, eventID, eventText, fieldName, liTpl, notesElm, start_splitted, start_time, targetElement, _i, _j, _k, _len, _len1, _len2, _liTpl, _liTplLink, _ref, _ref1, _ref2;
    event = this;
    this.page = $('#event');
    this._resetLayout();
