...
var current_page, deviceready, init, last_page, personalSchedule, platform, programXML, ua, xmlLoader;
...
deviceready = function() {
  return document.addEventListener('backbutton', function() {
    ...
    if ($.mobile.activePage.data('url') !== 'event') {
      ...
      return $('#event-back').click();
    }
  }, false);
};

init = function() {
  var a, date, dateSplitted, dayIndex, dayNode, dayTab, dayTab2Load, pageHref, _i, _len, _ref;
  dayTab2Load = void 0;
...
if (platform.android || platform.ios) {
  $(function() {
    return document.addEventListener('deviceready', deviceready, true);
  });
} else {
  deviceready();
}
